...
tools: Read, Write, mcp__claude_ai_Figma__whoami, mcp__claude_ai_Figma__get_metadata, mcp__claude_ai_Figma__get_screenshot, mcp__claude_ai_Figma__get_libraries, mcp__claude_ai_Figma__search_design_system
model: haiku
---
