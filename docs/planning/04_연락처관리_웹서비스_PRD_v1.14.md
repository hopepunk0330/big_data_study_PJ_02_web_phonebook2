...
> **변경 이력**
> - **v1.14 (2026-07-18)**: §5 "유스케이스 상세 ③ — UC-09" 문단의 화면정의서 인용 경로가 구버전(`02_..._v1.17.md`)을 가리키고 있던 것을 실제 최신 버전(`02_연락처관리_웹서비스_화면정의서_v1.18.md`)으로 정정했습니다 — 02 문서가 harness-auditor 재검증에서 발견한 SCR-002 와이어프레임 범례 주석의 잘못된 절 인용(`§5 ⑤`)을 정정하는 라운드에서 v1.17→v1.18로 개정됨에 따른 인용 동기화입니다. 06 테스트계획서에 `TC-E2E-SCR003-09~12` 신설 라운드와 짝을 맞춰 함께 처리되었으며, 그 외 서술은 변경하지 않았습니다(surgical).
> - **v1.13 (2026-07-18)**: §5 "유스케이스 상세 ③ — UC-09" 문단의 화면정의서 인용 경로가 구버전(`02_..._v1.16.md`)을 가리키고 있던 것을 실제 최신 버전(`02_연락처관리_웹서비스_화면정의서_v1.17.md`)으로 정정했습니다 — 02 문서가 tech-architect 브리프를 근거로 SCR-002 "구성 요소와 동작" 표·Mermaid 플로우차트·와이어프레임 범례 주석의 카테고리 nav 클릭 필터링 정합화 갭을 처리하는 라운드에서 v1.16→v1.17로 개정됨에 따른 인용 동기화입니다. 그 외 서술은 변경하지 않았습니다(surgical).
> - **v1.12 (2026-07-18)**: §5 "유스케이스 상세 ③ — UC-09" 문단의 화면정의서 인용 경로가 구버전(`02_..._v1.15.md`)을 가리키고 있던 것을 실제 최신 버전(`02_연락처관리_웹서비스_화면정의서_v1.16.md`)으로 정정했습니다 — 02 문서가 SCR-002 카테고리 nav 목록 클릭 시 필터링 기능 추가를 정식 반영(버전/changelog 정합화)하는 라운드에서 v1.15→v1.16으로 개정됨에 따른 인용 동기화입니다. 그 외 서술은 변경하지 않았습니다(surgical).
> - **v1.11 (2026-07-17)**: §5 "유스케이스 상세 ③ — UC-09" 문단의 화면정의서 인용 경로가 구버전(`02_..._v1.14.md`)을 가리키고 있던 것을 실제 최신 버전(`02_연락처관리_웹서비스_화면정의서_v1.15.md`)으로 정정했습니다 — 02 문서가 harness-auditor 재발 방지 지적 2건(SCR-900 Mermaid `Q1` 401 분기 구조적 공백, SCR-003 "목적" 불릿 신설)을 반영하는 라운드에서 v1.14→v1.15로 개정됨에 따른 인용 동기화입니다. 그 외 서술은 변경하지 않았습니다(surgical).
> - **v1.10 (2026-07-17)**: §5 "유스케이스 상세 ③ — UC-09" 문단의 화면정의서 인용 경로가 구버전(`02_..._v1.13.md`)을 가리키고 있던 것을 실제 최신 버전(`02_연락처관리_웹서비스_화면정의서_v1.14.md`)으로 정정했습니다 — 02 문서가 harness-auditor 재검증에서 발견한 §8 "화면 공통 규칙" 표 "파괴적 동작 확인" 행 "1차 과제 대응" 칸의 잔여 정정을 마저 반영하는 라운드에서 v1.13→v1.14로 개정됨에 따른 인용 동기화입니다. 그 외 서술은 변경하지 않았습니다(surgical).
> - **v1.9 (2026-07-17)**: §5 "유스케이스 상세 ③ — UC-09" 문단의 화면정의서 인용 경로가 구버전(`02_..._v1.12.md`)을 가리키고 있던 것을 실제 최신 버전(`02_연락처관리_웹서비스_화면정의서_v1.13.md`)으로 정정했습니다 — 02 문서가 harness-auditor 재검증에서 발견한 SCR-002 "삭제" confirm→ConfirmModal 정정 잔여 2곳을 마저 반영하는 라운드에서 v1.12→v1.13으로 개정됨에 따른 인용 동기화입니다. 그 외 서술은 변경하지 않았습니다(surgical).
> - **v1.8 (2026-07-16)**: §5 "유스케이스 상세 ③ — UC-09" 문단의 화면정의서 인용 경로가 구버전(`02_..._v1.11.md`)을 가리키고 있던 것을 실제 최신 버전(`02_연락처관리_웹서비스_화면정의서_v1.12.md`)으로 정정했습니다 — 02 문서가 SCR-002 삭제 확인 모달 "confirm" 용어 정정 라운드에서 v1.11→v1.12로 개정됨에 따른 인용 동기화입니다. 그 외 서술은 변경하지 않았습니다(surgical).
> - **v1.7 (2026-07-16)**: §5 "유스케이스 상세 ③ — UC-09" 문단의 화면정의서 인용 경로가 구버전(`02_..._v1.9.md`)을 가리키고 있던 것을 실제 최신 버전(`02_연락처관리_웹서비스_화면정의서_v1.11.md`)으로 정정했습니다 — 02 문서가 SCR-900 4종 세트 보완 + SCR-002 모달 미니 와이어프레임 신설 라운드에서 v1.9→v1.11로 개정됨에 따른 인용 동기화입니다(중간 버전 v1.10을 거치지 않고 최종 버전으로 한 번에 맞춤). planning-writer가 잔여 갭으로 보고했던 항목을 이번 라운드에서 처리했습니다. 그 외 서술은 변경하지 않았습니다(surgical).
> - **v1.6 (2026-07-16)**: §5 "유스케이스 상세 ③ — UC-09" 문단의 화면정의서 인용 경로가 구버전(`02_..._v1.8.md`)을 가리키고 있던 것을 실제 최신 버전(`02_연락처관리_웹서비스_화면정의서_v1.9.md`)으로 정정했습니다 — 02 문서가 이번 라운드에서 v1.9로 개정됨에 따른 인용 동기화입니다(SCR-002 카테고리 nav 동적 목록·카운트 출처 보완 라운드). 그 외 서술은 변경하지 않았습니다(surgical).
> - **v1.5 (2026-07-16)**: §5 "유스케이스 상세 ③ — UC-09" 문단의 화면정의서 인용 경로가 구버전 (`02_..._v1.7.md`)를 가리키고 있던 것을 실제 최신 버전(`02_연락처관리_웹서비스_화면정의서_v1.8.md`)으로 정정했습니다 — 02 문서가 이번 라운드에서 v1.8로 개정됨에 따른 인용 동기화입니다. 그 외 서술은 변경하지 않았습니다(surgical).
> - **v1.4 (2026-07-16)**: §5 "유스케이스 상세 ③ — UC-09" 문단의 화면정의서 인용 경로가 이미 `docs/planning/old/`로 이동된 구버전(`02_..._v1.5.md`)을 가리키고 있던 것을 실제 최신 버전(`02_연락처관리_웹서비스_화면정의서_v1.6.md`)으로 정정했습니다. harness-auditor 감사에서 발견되었으며, grep으로 실제 경로를 재확인한 뒤 반영했습니다. 그 외 서술은 변경하지 않았습니다(surgical).
...
화면정의서 SCR-004의 Mermaid 플로우(§4 참고, `docs/planning/02_연락처관리_웹서비스_화면정의서_v1.18.md`)와 1:1 대응하는 상세 단계입니다.
